...
ALTER TABLE #WGPTable ADD  CONSTRAINT [WGP] PRIMARY KEY CLUSTERED 
(
       OBJECTID_1 ASC
...
CREATE SPATIAL INDEX [WGPP] ON #WGPTable
(
       [Shape]
...
--TRUNCATE TABLE [ArcGis_Master].[dbo].[CYGNET_NAMES]
--INSERT INTO [ArcGis_Master].[dbo].[CYGNET_NAMES] (OBJECTID, SHAPE, WSN,WELL_NAME,WELL_SHORT_NAME,CYGNET_NAME,LATITUDE,LONGITUDE,TvB,DEDICATION,LIMIT)
select ROW_NUMBER() OVER(ORDER BY WSN  ASC) as OBJECTID
,#CDPAll.Shape
,WSN
,WELL_NAME
,WELL_SHORT_NAME
...
WHERE TvB = 'TH' AND WSN = '44902'-- like '%6814%'
